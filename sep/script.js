...
${indent(3)}RetailzPOS: Version Code 216 (Portal 1, 2, 3, 4, 6, 7, 8)
${indent(3)}Moolah Points: Version Code 37 (Portal 1, 2, 3, 4, 6, 7, 8)
...
${indent(1)}7. Tasks/Tickets to be Delegated: No delegated task for today`;
  ...
  function generateShiftReportHTML() {
    ...
    const versionHtml = `
        ...
        <div style="margin-left:50px;">RetailzPOS: Version Code 216 (Portal 1,2, 3, 4, 6, 7, 8)</div>
        <div style="margin-left:50px;">Moolah Points: Version Code 37 (Portal 1,2, 3, 4, 6, 7, 8)</div>
    `;
  ...
  function checkAndRefreshTable() {
    ...
    if (storedDate !== todayEST) {
      ...
      // ✅ Add this: reload after a short delay (so user sees the notification)
      setTimeout(() => {
  ...
  function init() {
    ...
    // ========== IDLE-BASED AUTO-REFRESH (5 minutes inactivity, silent) ==========
    const IDLE_REFRESH_DELAY = 900000; // 15 minutes
    let idleTimeout;
